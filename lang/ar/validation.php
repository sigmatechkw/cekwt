...
return [
    ...
    'doesnt_start_with' => 'لا يمكن أن تبدأ attribute بواحدة مما يلي: :values.',
    ...
    'password' => [
        'letters' => 'يجب أن تحتوي :attributeعلى حرف واحد على الأقل.',
        'mixed' => 'يجب أن تحتوي :attribute على حرف كبير واحد على الأقل وحرف صغير واحد.',
        'numbers' => 'يجب أن تحتوي :attribute على رقم واحد على الأقل.',
        'symbols' => 'يجب أن تحتوي :attribute على رمز واحد على الأقل.',
        'uncompromised' => 'ظهرت السمة :attribute المقدمة في تسريب بيانات. يرجى اختيار سمة :attribute مختلفة.',
    ],
