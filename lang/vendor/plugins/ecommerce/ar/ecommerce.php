...
return [
    ...
    'theme_options' => [
        ...
        'page_slug_description' => 'سيبدو الأمر مثل :slug عند الوصول إلى الصفحة. القيمة الافتراضية هي :default.',
        'page_slug_already_exists' => 'تم استخدام عنوان الصفحة :slug بالفعل. يرجى اختيار عنوان آخر.',
        'page_slugs' => [
            'login' => 'تسجيل الدخول',
            'register' => 'يسجل',
        ...
        'merchant_return_policy_url' => 'URL سياسة إرجاع التاجر',
