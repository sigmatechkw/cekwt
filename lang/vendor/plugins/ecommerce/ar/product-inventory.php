...
return [
    ...
    'import' => [
        ...
        'done_message' => 'تحديث:count product(s) بنجاح.',
        'rules' => [
            ...
            'stock_status' => 'يعد حقل حالة المخزون إلزاميًا عند إدارة المستودعات على أنه "لا" ويجب أن يكون أحد القيم التالية: :statuses.',
        ],
    ],
    'export' => [
