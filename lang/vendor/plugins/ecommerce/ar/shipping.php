...
return [
    ...
    'statuses' => [
        ...
        'picking' => 'اختيار',
        'delay_picking' => 'تأخير الاختيار',
        'picked' => 'تم الاختيار',
        'not_picked' => 'لم يتم اختياره',
        'delivering' => 'توصيل',
        'delivered' => 'تم التوصيل',
        'not_delivered' => 'لم يتم توصيلها',
        'audited' => 'مدققة',
        'canceled' => 'ألغيت',
    ...
    'updated_cod_status_by' => 'تم تحديث حالة الدفع عند الاستلام إلى :status . تم التحديث بواسطة: %user_name%',
    'all' => 'الجميع',
    ...
    'rule' => [
        ...
        'item' => [
            ...
            'bulk-import' => [
                ...
                'greater_than_or_equal' => 'يتم قبول الأرقام أو الأعداد العشرية فقط والتي تكون أكبر من أو تساوي :min.',
                'less_than_or_equal' => 'يتم قبول الأرقام أو الأعداد العشرية فقط والتي تكون أقل من أو تساوي :max.',
                'between' => 'يتم قبول الأرقام أو الأعداد العشرية فقط، وبين :min و :max.',
    ...
    'customer_confirmed_delivery_at' => 'تم تأكيد التسليم من قبل العميل في',
    'currency' => 'Currency',
