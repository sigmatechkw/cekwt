...
return [
    ...
    'visits' => 'الزيارات',
    'views' => 'الآراء',
    'start_date_can_not_before_end_date' => 'تاريخ البدء :start_date لا يمكن أن يكون بعد تاريخ النهاية :end_date',
    ...
    'settings' => [
        ...
        'credential_is_not_valid' => 'بيانات اعتماد التحليلات غير صالحة. المستند هنا: :url',
        ...
        'wrong_configuration' => 'لعرض التحليلات، ستحتاج إلى الحصول على معرف عميل Google Analytics وإضافته إلى إعداداتك.<br /> تحتاج أيضًا إلى بيانات اعتماد JSON.<br /> المستند هنا: :url',
